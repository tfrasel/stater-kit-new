...
// Agentflow collection schema
const agentflowCollection = defineCollection({
  loader: glob({ pattern: "**/-*.{md,mdx}", base: "src/content/agentflow" }),
  schema: z.any(),
});
